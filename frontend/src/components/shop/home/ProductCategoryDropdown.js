...
const CategoryList = () => {
  ...
  return (
    <div className={`${data.categoryListDropdown ? "" : "hidden"} my-4 category-icon-wrapper1`}>
      <hr />
      <div className="py-1 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 responsive-width">
            ...
            return (
              <Fragment key={index}>
                <div
                  ...
                  className="col-span-1 m-2 flex flex-col items-center justify-center space-y-2 cursor-pointer category-image-wrap"
...
const FilterList = () => {
  ...
  return (
    <div className={`${data.filterListDropdown ? "" : "hidden"} my-4 category-icon-wrapper`}>
      <hr />
      <div className="w-full flex flex-col">
        ...
        <div className="flex justify-between items-center">
          ...
          <div onClick={(e) => closeFilterBar()} className="cursor-pointer">
            <svg
              className="w-8 h-8 text-gray-700 hover:bg-black rounded-full p-1"
              fill="none"
              stroke="red"
              viewBox="0 0 24 24"
  ...
  return (
    ...
    >
      <input
        ...
        className="px-max text-xl py-6 focus:outline-none"
        type="text"
