...
const ProductDetailsSection = (props) => {
  ...
  return (
    <Fragment>
      ...
      />
      <section className="m-4 md:mx-12  md:my-12">
        <div className="grid grid-cols-2 md:grid-cols-12">
          ...
          <div className="col-span-1 md:col-span-7">
            <div className="relative">
              <img
                ...
                alt="Pic"
              />
              <div className="absolute inset-0 flex justify-evenly items-center mb-0">
                {/* <svg
                  onClick={(e) =>
                    slideImage("increase", null, count, setCount, pImages)
                  }
                  className="flex justify-center  w-12 h-120 text-gray-700 opacity-100 cursor-pointer hover:text-yellow-700 hover:opacity-100"
                  fill="green"
                  stroke="currentColor"
                  viewBox="24 24 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <svg
                  ...
                  className="flex justify-center  w-12 h-12 text-gray-700 opacity-100 cursor-pointer hover:text-yellow-700 hover:opacity-100"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-3 md:ml-6 lg:ml-5">
            <div className="flex flex-col leading-8">
              <div className="text-3xl tracking-wider">{sProduct.pName}</div>
